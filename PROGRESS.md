...
- **Code-review handoff:** Restored the 26 implemented backend/demo issues (#23–#40, #59–#63, #69–#71) to **@BhavyaSoneji** as the assignee and opened PR #78 for review. Requested **@neevmodh** as a PR reviewer for independent code review/testing; this does not transfer issue ownership. #77 remains with @BhavyaSoneji because the `frontend/raj` rebase is still outstanding.
